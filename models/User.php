...
class User implements \JsonSerializable
{
    ...
    */
    ...
    {
        $this->db->query(
            "UPDATE user_info SET username=?, email=?, password=?, salt=?, firstname=?, lastname=?, joined=?, user_type=?, bio=?, cover=?, picture=?, private=? WHERE id=?",
            array(
                $this->username,
                $this->email,
                $this->password,
    ...
    {
        $this->db->query(
            "UPDATE user_info SET $property=? WHERE id=?",
            array(
                $new_value,
                $this->id
            )
